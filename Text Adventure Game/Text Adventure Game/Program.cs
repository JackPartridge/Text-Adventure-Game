...
namespace Text_Adventure_Game
{
    class MainSpace
    {
        /* for ranged attacks need arrows, for melee need new wepons, enemies give drops such as wolf pelt, implement armour, more armour, more chance enemies 
        ...
        //enemy stats for bestiary and combat
        public static readonly List<string> enemyName = new List<string> { "Wolf", "Sheno", "Acmer", "Pipheon", "Woedel", "Xenome" };
        public static readonly List<int> enemyHP = new List<int> { 100, 130, 180, 240, 400, 260 };
        public static readonly List<int> defaultEnemyHP = new List<int> { 100, 130, 180, 240, 400, 260 };
        public static readonly List<int> enemyMaxDmg = new List<int> { 20, 40, 60, 100, 30, 150 };
        ...
        public static void Combat(bool tutorial)
        {
            ...
            do
            {
                ...
                correct = 0;
                Console.Clear();
                if (!bestiary.Contains(enemyName[0]))
                {
                    bestiary.Add(enemyName[0]);
                }
        ...
        public static void CharacterCreation()
        {
            ...
            do
            {
                ...
                if (playerGender == "jack")
                {
                    ...
                    playerMagic += 10000;
                    correct = 1;
                    Parallel.Invoke(() => ManaRegen(), () => Start(), () => BestiaryCheck(), () => InventoryCheck());
                }
            } while (correct == 0);
            correct = 0;
        ...
        public static void BestiaryCheck()
        {
            do
            {
                if (input == "b")
        ...
        public static void Start()
        {
            ...
            do
            {
                ...
                Match inspect = new Regex(@"(go |head |move|travel|walk )").Match(input);
                Match pickUp = new Regex(@"(go |head |move|travel|walk )").Match(input);
